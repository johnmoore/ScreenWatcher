...
#Region "Structures"
    ...
    Structure PeriodStudent
        ...
        Public Sub New(ByVal Type As StudentNodeType, ByVal Name As String, ByVal Position As Point, ByVal RemoveNode As EventHandler, ByVal NodeAction As EventHandler)
            ...
            End With
            'handlers
            'AddHandler Controls.btnRemove.Click, New EventHandler(AddressOf RemoveNode)
            'AddHandler Controls.grpMain.Click, New EventHandler(AddressOf NodeAction)
...
#Region "Reload Methods"
    ...
    Private Sub ReloadOverview()
        ...
        For Each PeriodStudent As PeriodStudent In MainPeriodStudents
            ...
            Dim DisplayName As String = PeriodStudent.Data.NodeName
            If System.Text.RegularExpressions.Regex.Replace(PeriodStudent.Data.NodeName, "[^a-z,A-Z]", "").Length > 8 Then
                DisplayName = DisplayName.Substring(0, 8) & "..."
            End If
            If PeriodStudent.Data.NodeType = StudentNodeType.Student Then
                DisplayName = System.Text.RegularExpressions.Regex.Replace(PeriodStudent.Data.NodeName, "[^a-z,A-Z]", "")
...
#Region "Tool Methods"
    ...
    Private Function GetStudentType(ByVal Name As String) As StudentNodeLocation
        'Dim index As Integer = 0
        'For Each StudentLocation As Collection In PeriodStudentCollections
        'If StudentLocation.Contains(Name) = True Then
        'If CollectionContains(StudentLocation, Name) = True Then
        'Return index
        'Exit Function
        'End If
        'index += 1
    ...
    Private Sub MoveNodeToBank(ByVal PeriodStudent As PeriodStudent)
        Try
            Dim AddPeriodStudent As New PeriodStudent(PeriodStudent.Data.NodeType, PeriodStudent.Data.NodeName, New Point, evtRemoveNode, evtNodeAction)   'PeriodStudent.Data.Position)
