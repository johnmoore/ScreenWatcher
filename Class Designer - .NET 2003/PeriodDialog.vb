...
#End Region
        ...
        Select Case Mode
            Case PeriodMode.EditPeriod
                ...
                ElseIf txtPeriodTitle.Text.Length < 1 Then
                    ...
                    Exit Sub
                Else
                    'ClassDesigner.pPeriodInfo.PeriodNumber = Val(txtPeriodNumber.Text)
                    'ClassDesigner.pPeriodInfo.Title = txtPeriodTitle.Text
                    ClassDesigner.EditPeriodInfo(Val(txtPeriodNumber.Text), txtPeriodTitle.Text)
                End If
                'ClassDesigner.pPeriodDialog.bolOpen = False
            ...
            Case PeriodMode.NewPeriod
                ...
                ElseIf txtPeriodTitle.Text.Length < 1 Then
                    ...
                    Exit Sub
                Else
                    'ClassDesigner.pPeriodInfo.Dimensions = New Point(Val(txtRows.Text), Val(txtSeatsPerRow.Text))
                    'ClassDesigner.pPeriodInfo.PeriodNumber = Val(txtPeriodNumber.Text)
                    'ClassDesigner.pPeriodInfo.Title = txtPeriodTitle.Text
    ...
    Private Sub txtPeriodTitle_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtPeriodTitle.TextChanged
